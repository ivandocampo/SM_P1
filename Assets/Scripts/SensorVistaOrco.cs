...
/// <summary>
/// Sensor de visión event-driven para agentes (guardias y arañas).
/// En vez de ser consultado por el cerebro cada frame, este sensor
/// NOTIFICA al cerebro mediante eventos C# cuando detecta algo relevante.
/// 
/// Eventos disponibles:
///   OnObjetivoDetectado(Vector3 posición) — El ladrón ha entrado en el campo de visión
///   OnObjetivoPerdido()                   — El ladrón ha salido del campo de visión
///   OnObjetivoVisible(Vector3 posición)   — El ladrón sigue visible (actualización continua)
///   OnAnilloDesaparecido()                — El anillo ya no está en el pedestal
/// </summary>
public class SensorVision : MonoBehaviour
{
    ...
    /// <summary>
    /// Evalúa si el objetivo es visible teniendo en cuenta:
    /// invisibilidad del anillo, distancia, ángulo del campo de visión, y obstáculos.
    /// </summary>
    ...
    /// <summary>
    /// Comprueba si el anillo ha desaparecido del pedestal.
    /// Solo notifica una vez (la primera detección).
    /// </summary>
    ...
    /// <summary>
    /// Indica si el anillo sigue activo en la escena.
    /// </summary>
