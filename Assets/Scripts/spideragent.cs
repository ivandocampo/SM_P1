...
/// <summary>
/// Agente Araña — Centinela estático del sistema multiagente.
/// 
/// Las arañas no se mueven. Se colocan en puntos estratégicos del mapa
/// y utilizan sus sensores para detectar al ladrón. Cuando detectan algo,
/// envían mensajes INFORM a los guardias mediante FIPA-ACL.
/// 
/// Arquitectura:
///   - SensorVision y/o SensorOido (percepción)
///   - ComunicacionAgente (comunicación FIPA-ACL)
///   - Sin actuadores de movimiento
///   - Sin BDI (lógica reactiva simple)
/// 
/// Componentes necesarios en el GameObject:
///   - ComunicacionAgente (se inicializa aquí)
///   - SensorVision y/o SensorOido (configurados en el Inspector)
/// </summary>
